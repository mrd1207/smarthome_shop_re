...
export default {
  ...
  methods: {
    ...
    saveGoodsInfo() {
      ...
      let goodInfoParams = `goods_id=${this.goodsInfo.goods_id}&goods_name=${this.goodsInfo.goods_name}&short_name=${this.goodsInfo.short_name}&price=${this.goodsInfo.price}&counts=${this.goodsInfo.counts}&category=${this.goodsInfo.category}`;
      this.$store.dispatch("updateGoods", goodInfoParams).then(res => {
